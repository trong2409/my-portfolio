        ...
        <div className="flex flex-col xl:flex-row justify-between rounded-md overflow-hidden p-5 xl:px-20 xl:py-10 border-solid border-4 border-[#2f3744]">
          <div className="w-full xl:w-5/2">
            <div className="mb-5">
              <label
                for="name"
                className="block mb-2 text-lg font-lagre text-gray-900 dark:text-white"
              >
                Your name
              </label>
              <div className="flex">
                ...
                <input
                  type="text"
                  id="name"
                  className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-lg border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div className="mb-5">
              <label
                for="website-admin"
                class="block mb-2 text-lg font-lagre text-gray-900 dark:text-white"
              >
                Your message
              </label>
              <div class="flex">
          ...
          <div className="w-full xl:w-1/2">
            ...
            <div className="flex-center">
              <a href="https://github.com/trong2409">
                <button
                  type="button"
                  class="w-40 text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                >
                  <svg
                    class="mr-2 -ml-1 w-4 h-4"
                    aria-hidden="true"
            ...
            <div className="flex-center">
              <a href="https://twitter.com/">
                <button
                  type="button"
                  class="w-40 text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mr-2 mb-2"
                >
                  <svg
                    class="mr-2 -ml-1 w-4 h-4"
                    aria-hidden="true"
